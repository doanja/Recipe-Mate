...
import { AuthRoute, FavoritesRoute, UserRoute } from '../routes';
...
class App {
  ...
  constructor(env: EnvVariables = new EnvVariables(), routes: Route[] = [new FavoritesRoute(), new UserRoute(), new AuthRoute()]) {
    this.app = express();
    this.port = env.port;
